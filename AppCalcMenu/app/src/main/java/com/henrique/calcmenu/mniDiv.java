...
public class mniDiv extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mni_div);
        ...
        btnCalc.setOnClickListener(view -> {
            ...
            Toast.makeText(this, "A divisão é: " + (num1 / num2), Toast.LENGTH_SHORT).show();
        });
    }
}