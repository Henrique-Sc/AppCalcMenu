...
public class mniSub extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mni_sub);
        ...
        btnCalc.setOnClickListener(view -> {
            ...
            Toast.makeText(this, "A subtração é: " + (num1 - num2), Toast.LENGTH_SHORT).show();
        });
    }
}